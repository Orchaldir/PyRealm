...
if __name__ == "__main__":
    ...
    suites.append(model.map.map_get_province_test.get_tests())
    suites.append(model.map.province_add_army_test.get_tests())
    suites.append(model.map.province_get_neighbour_test.get_tests())
    suites.append(model.map.province_is_neighbour_test.get_tests())
    suites.append(model.map.province_remove_army_test.get_tests())
